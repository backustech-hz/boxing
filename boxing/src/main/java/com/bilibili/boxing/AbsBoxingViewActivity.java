...
public abstract class AbsBoxingViewActivity extends AppCompatActivity implements PickerContract.View {
    ...
    public final void loadRawImage(@NonNull View img, @NonNull String path, int failImageResId, IBoxingCallback callback) {
        BoxingMediaLoader.getInstance().displayRaw(img, path, failImageResId, callback);
    }
